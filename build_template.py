...
the_ultimate_city = BuildTemplate(width=29, height=29, placements=(
    ...
    Placement(Building.HousePioneers, (9, 1)),
    Placement(Building.HousePioneers, (11, 1)),
    Placement(Building.HousePioneers, (13, 1)),
    Placement(Building.DirtRoad, (15, 1)),
    Placement(Building.HousePioneers, (16, 1)),
    Placement(Building.HousePioneers, (18, 1)),
    Placement(Building.HousePioneers, (20, 1)),
